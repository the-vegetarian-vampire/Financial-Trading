...
os.environ["API_KEY"] = 'pk_1ac02e6bbf0e4a15913f49f6b86e70fc'
...
def buy():
    ...
    if request.method == "GET":
        ...
        if stock == None:
            return apology("Bruh, enter a symbol")
...
def register():
    ...
    if request.method == "POST":
        ...
        try:
            ...
            return apology("Duplicate username exists")
    else:
